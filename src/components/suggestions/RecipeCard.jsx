...
export default function RecipeCard({ recipe, onAdd }) {
  ...
  return (
    <div className="bg-bg-card rounded-lg border border-border px-3.5 py-3.5 transition-all duration-300 ease-out hover:border-border-secondary hover:bg-bg-hover/70 shadow-card hover:shadow-card-hover">
